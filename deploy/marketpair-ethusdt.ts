...
const LAST_PRICE = 3770; // ETH/USDT from TradingView
const ethIdBytes32 = ethers.id("cETH");
...
console.log(`cETH assetId: ${ethIdBytes32}`); // 0xb3c46c78043b5ff6963757142af6c297cddb5a0d3d823357472228eb35c8e890
console.log(`cUSDT assetId: ${usdtIdBytes32}`); // 0xd010e8c9393965b2e6fb1d28e8485d90bf8a0a032cd79943a8788efb6f0bd3e3

const mpETHUSDT: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(`MarketPair cETH/cUSDT contract: `, deployed.address);
};
export default mpETHUSDT;
mpETHUSDT.id = "deploy_marketpair_ethusdt"; // id required to prevent reexecution
mpETHUSDT.tags = ["MarketPairETHUSDT"];
// Ensure Vault is deployed before this script runs
mpETHUSDT.dependencies = ["Vault"];
